...
minethd::cn_hash_fun_multi minethd::func_multi_selector(size_t N, bool bHaveAes, bool bNoPrefetch, xmrstak_algo algo)
{
	...
	static const cn_hash_fun_multi func_table[] = {
		...
		cryptonight_penta_hash<cryptonight_monero, true, true>,
                cryptonight_double_hash<cryptonight_monero_xtl, false, false>,
		cryptonight_double_hash<cryptonight_monero_xtl, true, false>,
		cryptonight_double_hash<cryptonight_monero_xtl, false, true>,
		cryptonight_double_hash<cryptonight_monero_xtl, true, true>,
		cryptonight_triple_hash<cryptonight_monero_xtl, false, false>,
		cryptonight_triple_hash<cryptonight_monero_xtl, true, false>,
		cryptonight_triple_hash<cryptonight_monero_xtl, false, true>,
		cryptonight_triple_hash<cryptonight_monero_xtl, true, true>,
		cryptonight_quad_hash<cryptonight_monero_xtl, false, false>,
		cryptonight_quad_hash<cryptonight_monero_xtl, true, false>,
		cryptonight_quad_hash<cryptonight_monero_xtl, false, true>,
		cryptonight_quad_hash<cryptonight_monero_xtl, true, true>,
		cryptonight_penta_hash<cryptonight_monero_xtl, false, false>,
		cryptonight_penta_hash<cryptonight_monero_xtl, true, false>,
		cryptonight_penta_hash<cryptonight_monero_xtl, false, true>,
		cryptonight_penta_hash<cryptonight_monero_xtl, true, true>,
